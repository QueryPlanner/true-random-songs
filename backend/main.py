...
allowed_origins = os.getenv("ALLOWED_ORIGINS", "http://localhost:3000,http://localhost:8002,https://random-songs.lordpatil.com,https://songs-api.lordpatil.com").split(",")
